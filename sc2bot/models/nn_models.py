...
class FeatureCNN(nn.Module):
    ...
    def __init__(self, n_features):
        ...
        self.conv1 = nn.Conv2d(n_features, 12, kernel_size=2, stride=1, padding=1)
        self.conv2 = nn.Conv2d(12, 12, kernel_size=2, stride=1, padding=1)
        self.conv3 = nn.Conv2d(12, 1, kernel_size=2, stride=1, padding=1)
